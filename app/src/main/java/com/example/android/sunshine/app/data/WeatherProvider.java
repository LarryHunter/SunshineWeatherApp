...
public class WeatherProvider extends ContentProvider
{
	...
	private WeatherDbHelper m_weatherDbHelper;
	...
	private Cursor getWeatherByLocationSetting(Uri uri, String[] projection, String sortOrder)
	{
		...
		return sWeatherByLocationSettingQueryBuilder.query(m_weatherDbHelper.getReadableDatabase(),
			projection,
			selection,
			selectionArgs,
			null,
...
//		return uriMatcher;
	...
	{
		m_weatherDbHelper = new WeatherDbHelper(getContext());
		return true;
	}
	...
	{
		final SQLiteDatabase db = m_weatherDbHelper.getWritableDatabase();
		final int match = sUriMatcher.match(uri);
		Uri returnUri;
